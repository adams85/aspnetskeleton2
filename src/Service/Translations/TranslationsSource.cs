...
{
    internal sealed class TranslationsSource : ITranslationsSource, IDisposable
    {
        ...
        public TranslationsSource(IEventNotifier eventNotifier, IClock clock, IOptions<TranslationsSourceOptions>? options, ILogger<TranslationsSource>? logger)
        {
            ...
            _reloadOnChange = optionsValue?.ReloadOnChange ?? TranslationsSourceOptions.DefaultReloadOnChange;
            _reloadDelay = optionsValue?.ReloadDelay ?? TranslationsSourceOptions.DefaultReloadDelay;
            _delayOnWatcherError = optionsValue?.DelayOnWatcherError ?? TranslationsSourceOptions.DefaultDelayOnWatcherError;
